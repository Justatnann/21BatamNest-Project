const dataBarang = [
  { no: 1, date: "2022-22-10", nama: "Wallet kering Kuning", harga: 10000, jumlah: 5 },
  { no: 2, date: "2022-22-10", nama: "Wallet kering Kakian", harga: 15000, jumlah: 3 },
  { no: 3, date: "2022-22-10", nama: "Wallet kering A Ori", harga: 10000, jumlah: 5 },
  { no: 4, date: "2022-22-10", nama: "Wallet kering Mangkok", harga: 15000, jumlah: 3 },
  { no: 5, date: "2022-22-10", nama: "Wallet kering Merah ", harga: 10000, jumlah: 5 },
  { no: 6, date: "2022-22-10", nama: "Wallet kering Hancuran", harga: 15000, jumlah: 3 },
  { no: 7, date: "2022-22-10", nama: "Wallet kering Segi Abu", harga: 10000, jumlah: 5 },
  { no: 8, date: "2022-22-10", nama: "Botolan Panjang 100", harga: 15000, jumlah: 3 },
  { no: 9, date: "2022-22-10", nama: "Botolan Panjang 100", harga: 10000, jumlah: 5 },
  { no: 10, date: "2022-22-10", nama: "Botolan Panjang 100", harga: 15000, jumlah: 3 },
  { no: 11, date: "2022-22-10", nama: "Botolan Panjang 100", harga: 10000, jumlah: 5 },
  { no: 12, date: "2022-22-10", nama: "Botolan Panjang 100", harga: 15000, jumlah: 3 },
  { no: 13, date: "2022-22-10", nama: "Botolan Panjang 100", harga: 10000, jumlah: 5 },
  { no: 14, date: "2022-22-10", nama: "Botolan Panjang 100", harga: 15000, jumlah: 3 },
];
...
function detailBarang(no) {
  ...
  if (selectedBarang) {
    ...
    window.location.href = `detailinventory.html?data=${selectedBarangJSON}`;
  }
}
...
function redirectToInventoryReport() {
  window.location.href = "InvLap.html";
}
